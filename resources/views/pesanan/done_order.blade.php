          ...
          <div class="col-md-9 ms-sm-auto col-lg-12 px-md-12">
           ...
           <div class=" d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="col-sm-12 me-auto">
              <form action="/market-done-order/{{ $slug_id }}" method="GET">
                <div class="col-sm-4">
            ...
            <div class="col-sm-5  mb-4">
              <div class="card mb-3">
                  <div class="card-header text-center">
                     <span class="text-capitalize">{{ $orders->status_pesanan }}  <span><i class="fa-sharp fa-solid fa-circle-check fa-lg" style="color:goldenrod;"></i></span></span>
                    </div>
                  <div class="card-body">
                     <div class="d-flex text-center">
                      ...
                      <div class="d-flex flex-column w-100">
                          ...
                          <span class="icon ms-auto" style="cursor: pointer;" id="detailtgl{{ $orders->id }}"> <i class="fa-sharp fa-solid fa-bars"></i></span>
                          </div>
                      </div>
                     </div>
            ...
            <div class="pros col-sm-12">
              ...
              <p class="text-center mt-4" style="font-size:24px; color:rgb(179, 172, 172)">
                  Tidak ada sepatu yang sudah selesai!
              </p>
          </div>
          @endif
